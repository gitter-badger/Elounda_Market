...
# ---------------------------------------------------------------------------------------------------------------------
        ...
        if message.content.lower() == 'help':
            await message.channel.send(':white_check_mark: COMPLETE LIST OF COMMANDS')
            await message.channel.send(':one: refresh daily')
            await message.channel.send(':two: refresh monthly')
            await message.channel.send(':three: orders?')
            await message.channel.send(':four: delete orders')
            await message.channel.send(':five: add order')
            await message.channel.send(':six: delete pre cost')
            await message.channel.send(':seven: add pre cost')
            await message.channel.send(':eight: add bazaar')
            await message.channel.send(':nine: history')
            await message.channel.send(':one::zero: rm -rf')
