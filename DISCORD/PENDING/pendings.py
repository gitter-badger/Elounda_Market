...
def run():
    ...
    sql_answer_1 = pd.read_sql_query(sql.query_01(), sql_connect.sql_cnx())
    sql_answer_2 = pd.read_sql_query(sql.query_02(), sql_connect.sql_cnx())
    sql_answer_3 = pd.read_sql_query(sql.query_03(), sql_connect.sql_cnx())
